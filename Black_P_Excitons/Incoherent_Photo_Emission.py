...
def Fitting_Parameters(x1,nkx,nky,nkz,ψ,direccion,QQ):
    ...
    if direccion =='kx':
        poptx, pcovx = curve_fit( func_q_eq_0, x1,np.reshape(ψ[0,:], [nkx,nky,nkz])[:,int(nky/2),int(nkz/2)], bounds=((-np.inf,-np.inf,-np.inf), (np.inf,np.inf,np.inf)) )
        popty, pcovy = curve_fit( func_q_eq_0, x1,np.reshape(ψ[0,:], [nkx,nky,nkz])[int(nkx/2),:,int(nkz/2)], bounds=((-np.inf,-np.inf,-np.inf), (np.inf,np.inf,np.inf)) )
        poptz, pcovz = curve_fit( func_q_nq_0, x1,np.reshape(ψ[0,:], [nkx,nky,nkz])[int(nkx/2),int(nky/2),:],p0=np.array([1,1,1,-np.sign(QQ)]), bounds=((-np.inf,-np.inf,-np.inf,-np.inf), (np.inf,np.inf,np.inf,np.inf)) )
        poptx[2] = 0.0
        popty[2] = 0.0
    ...
    if direccion =='ky':
        ...
        popty, pcovy = curve_fit( func_q_nq_0, x1,np.reshape(ψ[0,:], [nkx,nky,nkz])[int(nkx/2),:,int(nkz/2)],p0=np.array([1,1,1,np.sign(QQ)]), bounds=((-np.inf,-np.inf,-np.inf,-np.inf), (np.inf,np.inf,np.inf,np.inf)) )
        poptz, pcovz = curve_fit( func_q_eq_0, x1,np.reshape(ψ[0,:], [nkx,nky,nkz])[int(nkx/2),int(nky/2),:], bounds=((-np.inf,-np.inf,-np.inf), (np.inf,np.inf,np.inf)) )
        poptx[2] = 0.0
        poptz[2] = 0.0

    if direccion =='kz':
        poptx, pcovx = curve_fit( func_q_nq_0, x1,np.reshape(ψ[0,:], [nkx,nky,nkz])[:,int(nky/2),int(nkz/2)],p0=np.array([1,1,1,-np.sign(QQ)]), bounds=((-np.inf,-np.inf,-np.inf,-np.inf), (np.inf,np.inf,np.inf,np.inf)) )
        popty, pcovy = curve_fit( func_q_eq_0, x1,np.reshape(ψ[0,:], [nkx,nky,nkz])[int(nkx/2),:,int(nkz/2)], bounds=((-np.inf,-np.inf,-np.inf), (np.inf,np.inf,np.inf)) )
        poptz, pcovz = curve_fit( func_q_eq_0, x1,np.reshape(ψ[0,:], [nkx,nky,nkz])[int(nkx/2),int(nky/2),:], bounds=((-np.inf,-np.inf,-np.inf), (np.inf,np.inf,np.inf)) )
        popty[2] = 0.0
        poptz[2] = 0.0
